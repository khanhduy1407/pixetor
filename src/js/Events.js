...
var Events = {
   ...
   */
  PIXETOR_RESET: 'PIXETOR_RESET',
  PIXETOR_SAVE_STATE: 'PIXETOR_SAVE_STATE',
  PIXETOR_DESCRIPTOR_UPDATED : 'PIXETOR_DESCRIPTOR_UPDATED',
  PIXETOR_SAVED_STATUS_UPDATE : 'PIXETOR_SAVED_STATUS_UPDATE',
  ...
  /**
   * Fired when a Pixetor is successfully saved
   */
  PIXETOR_SAVED: 'PIXETOR_SAVED',
  /**
   * Fired when a save action starts
   */
  BEFORE_SAVING_PIXETOR: 'BEFORE_SAVING_PIXETOR',
  /**
   * Fired when a save action ends. Always fires, even if saving was not successful
   */
  AFTER_SAVING_PIXETOR: 'AFTER_SAVING_PIXETOR',
  ...
  PIXETOR_FILE_IMPORT_FAILED : 'PIXETOR_FILE_IMPORT_FAILED',
