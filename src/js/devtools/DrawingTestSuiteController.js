(function () {
  ...
  ns.DrawingTestSuiteController.prototype.start = function () {
    ...
    pxtr.utils.Xhr.get(this.suitePath, this.onTestSuiteLoaded_.bind(this));

    var testSuiteStatus = document.createElement('li');
    testSuiteStatus.innerHTML = pxtr.utils.Template.replace(
      '<b>Test Suite [{{path}}]</b>',
  ...
  ns.DrawingTestSuiteController.prototype.onTestCaseEnd_ = function (evt, testPath, success, performance) {
    ...
    testCaseStatus.innerHTML = pxtr.utils.Template.replace(
