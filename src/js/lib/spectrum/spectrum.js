...
(function (window, $, undefined) {
    ...
    function spectrum(element, o) {
        ...
        function show() {
            ...
            if (!flat) {
                 // Pixetor-specific : change the color as soon as the user does a mouseup
        ...
        // Pixetor-specific (code extracted to method)
        ...
        function updateUI() {
            ...
            if (opts.showInput) {
                var displayFormat = pxtr.UserSettings.get(pxtr.UserSettings.COLOR_FORMAT);
        ...
        function updateOriginalInput(fireCallback) {
            ...
            // Pixetor-specific : commented-out, palette update is done on hide
