(function () {
  ...
  /**
   * The frame picker widget displays a a simple UI to view the frames of a pixetor.
   * UI controls allow the user to browser through the frames
   * @param {Pixetor} pixetor
   *        The pixetor instance for which we want to preview frames.
   * @param {Node} container
   *        Node in which the widget should be inserted.
   */
  ns.FramePicker = function (pixetor, container) {
  ...
  ns.FramePicker.prototype.onLastClicked_ = function () {
    this.setFrameIndex(this.pixetor.getFrameCount());
  };
  ...
  ns.FramePicker.prototype.getFrameCount_ = function () {
    return this.pixetor.getLayerAt(0).getFrames().length;
  };
  ...
  ns.FramePicker.prototype.getFrameAsImage_ = function (frameIndex) {
    ...
    var frame = pxtr.utils.LayerUtils.mergeFrameAt(this.pixetor.getLayers(), frameIndex - 1);
  ...
  ns.FramePicker.prototype.getZoomLevel_ = function () {
    ...
    var wZoom = viewerWidth / this.pixetor.width;
    var hZoom = viewerHeight / this.pixetor.height;
