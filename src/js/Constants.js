// TODO(grosbouddha): put under pxtr namespace.
var Constants = {
  DEFAULT : {
    HEIGHT : 32,
    WIDTH : 32,
  ...
  // Maximum size of a sprite that can be saved on pixetorapp datastore.
  ...
  IMAGE_SERVICE_UPLOAD_URL : '{{protocol}}://pixetor-imgstore-b.appspot.com/__/upload',
  IMAGE_SERVICE_GET_URL : '{{protocol}}://pixetor-imgstore-b.appspot.com/img/'
};
