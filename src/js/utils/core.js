...
(function() { // namespace: pxtr.utils
  ...
  ns.rgbToHex = function (r, g, b) {
    return '#' + pxtr.utils.componentToHex(r) + pxtr.utils.componentToHex(g) + pxtr.utils.componentToHex(b);
  };
  ...
  ns.colorToInt = function (color) {
    ...
    if (tc && tc.ok) {
      ...
      return pxtr.utils.colorToInt(color);
    }
  };
