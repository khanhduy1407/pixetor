  ...
  ns.BlobUtils = {
    dataToBlob : function(dataURI, type, callback) {
      ...
      if (Blob.fake) {
        ...
        var blobData = isBase64 ? pxtr.utils.Base64.decode(data) : decodeURIComponent(data);
    ...
    canvasToBlob : function (canvas, callback, type /*, ...args*/) {
      ...
      if (canvas.mozGetAsFile) {
        ...
        pxtr.utils.BlobUtils.dataToBlob(dataURI, type, callback);
      }
    },

    stringToBlob : function (string, callback, type) {
      type = type || 'text/plain';
      pxtr.utils.BlobUtils.dataToBlob('data:' + type + ',' + string, type, callback);
    }
  };
})();
