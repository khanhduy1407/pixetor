(function () {
  ...
  ns.PaletteController.prototype.init = function() {
    ...
    pxtr.app.shortcutService.registerShortcut(shortcuts.COLOR.SWAP, this.swapColors.bind(this));
    pxtr.app.shortcutService.registerShortcut(shortcuts.COLOR.RESET, this.resetColors.bind(this));
  ...
  ns.PaletteController.prototype.swapColors = function () {
    var primaryColor = pxtr.app.selectedColorsService.getPrimaryColor();
    this.setPrimaryColor_(pxtr.app.selectedColorsService.getSecondaryColor());
