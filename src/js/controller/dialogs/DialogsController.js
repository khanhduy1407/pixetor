(function () {
  ...
  ns.DialogsController = function (pixetorController) {
    this.pixetorController = pixetorController;
    this.closePopupShortcut = pxtr.service.keyboard.Shortcuts.MISC.CLOSE_POPUP;
  ...
  ns.DialogsController.prototype.init = function () {
    ...
    var createPaletteShortcut = pxtr.service.keyboard.Shortcuts.COLOR.CREATE_PALETTE;
    pxtr.app.shortcutService.registerShortcut(createPaletteShortcut, this.onCreatePaletteShortcut_.bind(this));

    var cheatsheetShortcut = pxtr.service.keyboard.Shortcuts.MISC.CHEATSHEET;
    pxtr.app.shortcutService.registerShortcut(cheatsheetShortcut, this.onCheatsheetShortcut_.bind(this));
    pxtr.utils.Event.addEventListener('.cheatsheet-link', 'click', this.onCheatsheetShortcut_, this);
    ...
    pxtr.utils.Event.addEventListener(this.dialogWrapper_, 'click', this.onWrapperClicked_, this);
  };
  ...
  ns.DialogsController.prototype.showDialog = function (dialogId, initArgs) {
    ...
    this.dialogContainer_.innerHTML = pxtr.utils.Template.get(config.template);
    var controller = new config.controller(this.pixetorController);
    ...
    pxtr.app.shortcutService.registerShortcut(this.closePopupShortcut, this.hideDialog.bind(this));
  ...
  ns.DialogsController.prototype.hideDialog = function () {
    ...
    pxtr.app.shortcutService.unregisterShortcut(this.closePopupShortcut);
