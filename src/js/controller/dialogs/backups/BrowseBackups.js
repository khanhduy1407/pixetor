(function () {
  var ns = $.namespace('pxtr.controller.dialogs.backups');
  ...
  ns.BrowseBackups = function (pixetorController, args) {
  ...
  pxtr.utils.inherit(ns.BrowseBackups, pxtr.controller.dialogs.AbstractDialogController);
