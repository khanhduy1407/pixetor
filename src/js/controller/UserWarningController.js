(function () {
  ...
  ns.UserWarningController = function (pixetorController, currentColorsService) {
  ...
  ns.UserWarningController.prototype.init = function () {
    ...
    pxtr.utils.Event.addEventListener(
      ...
      $.publish(Events.SHOW_NOTIFICATION, [{
        'content': 'Performance problem detected, ' +
                   '<a href="#" style="color:red;"' +
                       'onclick="pxtr.controller.UserWarningController.showPerformanceInfoDialog()">' +
                      'learn more?</a>',
        'hideDelay' : 5000
      }]);
    }
