(function() {
  ...
  ns.VerticalMirrorPen = function() {
    ...
    this.shortcut = pxtr.service.keyboard.Shortcuts.TOOL.MIRROR_PEN;
  ...
  pxtr.utils.inherit(ns.VerticalMirrorPen, ns.SimplePen);
  ...
  ns.VerticalMirrorPen.prototype.applyToolAt = function(col, row, frame, overlay, event) {
    ...
    var hasCtrlKey = pxtr.utils.UserAgent.isMac ?  event.metaKey : event.ctrlKey;
    if (!hasCtrlKey) {
  ...
  ns.VerticalMirrorPen.prototype.getPenSizeOffset_ = function(row, frame) {
    return pxtr.app.penSizeService.getPenSize() % 2;
  };
})();
