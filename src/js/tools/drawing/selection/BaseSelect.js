/**
 * @provide pxtr.tools.drawing.selection.BaseSelect
 *
 * @require pxtr.utils
 */
(function() {
  ...
  ns.BaseSelect = function() {
    this.secondaryToolId = pxtr.tools.drawing.Move.TOOL_ID;
  ...
  pxtr.utils.inherit(ns.BaseSelect, pxtr.tools.drawing.BaseTool);
  ...
  ns.BaseSelect.prototype.moveUnactiveToolAt = function(col, row, frame, overlay, event) {
    ...
    if (!this.hasSelection) {
      pxtr.tools.drawing.BaseTool.prototype.moveUnactiveToolAt.apply(this, arguments);
    }
  };
  ...
  ns.BaseSelect.prototype.onSelectionDismissed_ = function () {
    var overlay = pxtr.app.drawingController.overlayFrame;
    overlay.clear();
    this.hasSelection = false;
  };
  ...
  ns.BaseSelect.prototype.getTransparentVariant_ = pxtr.utils.FunctionUtils.memo(function (colorStr) {
