/**
 * @provide pxtr.tools.drawing.Circle
 *
 * @require pxtr.utils
 */
(function() {
  ...
  ns.Circle = function() {
    ...
    this.shortcut = pxtr.service.keyboard.Shortcuts.TOOL.CIRCLE;
  };

  pxtr.utils.inherit(ns.Circle, ns.ShapeTool);
  ...
  ns.Circle.prototype.getCirclePixels_ = function (x0, y0, x1, y1, penSize) {
    ...
    var coords = pxtr.PixelUtils.getOrderedRectangleCoordinates(x0, y0, x1, y1);
    var pixels = [];
