(function () {
  ...
  ns.PaletteService.prototype.getPalettes = function () {
    var palettesString = this.localStorageGlobal.getItem('pixetor.palettes');
    var palettes = JSON.parse(palettesString) || [];
    palettes = palettes.map(function (palette) {
      return pxtr.model.Palette.fromObject(palette);
    });
  ...
  ns.PaletteService.prototype.savePalettes_ = function (palettes) {
    ...
    this.localStorageGlobal.setItem('pixetor.palettes', JSON.stringify(palettes));
