(function () {
  ...
  ns.Shortcut.prototype.getKeys = function () {
    var keys = pxtr.UserSettings.get(this.getLocalStorageKey_()) || this.defaultKeys_;
  ...
  ns.Shortcut.prototype.restoreDefault = function (keys) {
    pxtr.UserSettings.set(this.getLocalStorageKey_(), '');
  };

  ns.Shortcut.prototype.updateKeys = function (keys) {
    pxtr.UserSettings.set(this.getLocalStorageKey_(), keys);
  };
