(function () {
  var ns = $.namespace('pxtr.service.keyboard');
   ...
   * @param {pxtr.service.keyboard.Shortcut} shortcut
  ...
  ns.ShortcutService.prototype.registerShortcut = function (shortcut, callback) {
    if (!(shortcut instanceof ns.Shortcut)) {
      throw 'Invalid shortcut argument, please use instances of pxtr.service.keyboard.Shortcut';
    }
  ...
  ns.ShortcutService.prototype.getShortcutById = function (id) {
    return pxtr.utils.Array.find(this.getShortcuts(), function (shortcut) {
  ...
  /**
   * Restore the default pixetor key for all shortcuts
   */
