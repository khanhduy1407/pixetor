(function () {
  ...
  ns.CachedFrameRenderer = function (container, renderingOptions, classList) {
    pxtr.rendering.frame.FrameRenderer.call(this, container, renderingOptions, classList);
    this.serializedFrame = '';
  };

  pxtr.utils.inherit(pxtr.rendering.frame.CachedFrameRenderer, pxtr.rendering.frame.FrameRenderer);
  ...
  ns.CachedFrameRenderer.prototype.render = function (frame) {
    ...
    var serializedFrame = [
      ...
      this.getGridSpacing(),
      this.getGridColor(),
      pxtr.UserSettings.get('SEAMLESS_MODE'),
      pxtr.UserSettings.get('SEAMLESS_OPACITY'),
      offset.x, offset.y,
