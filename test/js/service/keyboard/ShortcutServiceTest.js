describe("ShortcutService test suite", function() {
  ...
  beforeEach(function() {
    service = new pxtr.service.keyboard.ShortcutService();
  });
  ...
  it("accepts only shortcut instances", function() {
    ...
    }).toThrow('Invalid shortcut argument, please use instances of pxtr.service.keyboard.Shortcut');
    ...
    var shortcut = new pxtr.service.keyboard.Shortcut('shortcut-id', '', A_KEY);
  ...
  it ("triggers shortcut", function () {
    ...
    var shortcutA = new pxtr.service.keyboard.Shortcut('shortcut-a', '', A_KEY);
  ...
  it ("triggers shortcuts independently", function () {
    ...
    var shortcutA = new pxtr.service.keyboard.Shortcut('shortcut-a', '', A_KEY);
    var shortcutB = new pxtr.service.keyboard.Shortcut('shortcut-b', '', B_KEY);
    var shortcutA_B = new pxtr.service.keyboard.Shortcut('shortcut-a&b', '', [A_KEY, B_KEY]);
  ...
  it ("supports meta modifiers", function () {
    ...
    var shortcuts = [
      new pxtr.service.keyboard.Shortcut('a', '', A_KEY),
      new pxtr.service.keyboard.Shortcut('a_ctrl', '', 'ctrl+' + A_KEY),
      new pxtr.service.keyboard.Shortcut('a_ctrl_shift', '', 'ctrl+shift+' + A_KEY),
      new pxtr.service.keyboard.Shortcut('a_ctrl_shift_alt', '', 'ctrl+shift+alt+' + A_KEY),
      new pxtr.service.keyboard.Shortcut('a_alt', '', 'alt+' + A_KEY)
    ];
