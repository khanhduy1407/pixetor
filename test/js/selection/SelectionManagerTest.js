describe("SelectionManager suite", function() {
  ...
  beforeEach(function() {
    currentFrame = pxtr.model.Frame.fromPixelGrid([
      [B, R, T],
      [R, B, R],
      [T, R, B]
    ]);

    selectionManager = new pxtr.selection.SelectionManager(pixetorController);
    selectionManager.init();

    selection = new pxtr.selection.BaseSelection();
