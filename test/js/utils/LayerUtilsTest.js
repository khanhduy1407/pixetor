describe("LayerUtils test", function() {
  ...
  it("flattens a frame", function() {
    // when
    var l1 = new pxtr.model.Layer('l1');
    l1.addFrame(frame1);
    var l2 = new pxtr.model.Layer('l2');
    l2.addFrame(frame2);

    // then
    var flattened = pxtr.utils.LayerUtils.flattenFrameAt([l1, l2], 0);
  ...
  it("flattens a frame with opacity", function() {
    ...
    // then
    var flattened = pxtr.utils.LayerUtils.flattenFrameAt([l1, l2], 0, true);
  ...
  it("clones a layer", function() {
    ...
    // when
    var layer = new pxtr.model.Layer('l1');
    layer.addFrame(pxtr.model.Frame.fromPixelGrid(grid1));
    layer.addFrame(pxtr.model.Frame.fromPixelGrid(grid2));
