...
casper.test.begin('Complex GIF export test', 11, function(test) {
  ...
  function onPixetorReset() {
    ...
    test.assertEquals(evalLine('pxtr.app.pixetorController.getPixetor().getWidth()'), 20, 'Pixetor width is now 20 pixels');
    test.assertEquals(evalLine('pxtr.app.pixetorController.getPixetor().getHeight()'), 20, 'Pixetor height is now 20 pixels');
